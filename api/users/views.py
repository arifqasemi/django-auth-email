...
from users.functions import send_verification_email
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if must_validate_email:
                ...
                send_verification_email(user.email, signup_code.code)

            content = {'message':'Please check you email, and  Verify your email'}
...
class SignupVerify(APIView):
    ...
    def get(self, request, format=None):
        ...
        if verified:
            ...
            content = {'detail': _('Unable to verify user.'),'code':code}
            return Response(content, status=status.HTTP_400_BAD_REQUEST)
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                if user.is_verified and user.is_active:
                    ...
                    content = {'message': 'please check your email to verify'}
                    return Response(content, status=status.HTTP_201_CREATED)
